<?php if($staff->type == 1): ?>
	<?php $__env->startSection('title', 'Update Sample Transporter'); ?>
<?php elseif($staff->type == 2): ?>
	<?php $__env->startSection('title', 'Update Sample Receptionist'); ?>
<?php elseif($staff->type == 4): ?>
	<?php $__env->startSection('title', 'Update Driver'); ?>
<?php elseif($staff->type == 5): ?>
	<?php $__env->startSection('title', 'Update EOC Staff Member'); ?>
<?php else: ?>
<?php endif; ?>
...
<?php $__env->startSection('content'); ?>
	<div class="box box-info">
            ...
            <?php echo e(Form::model($staff, array('route' => array('staff.update', $staff->id),  'class' => 'form-horizontal', 'id' => 'staffform', 'method' => 'PUT'))); ?>
              ...
              <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <?php echo e(Form::select('facilityid', $hubsdropdown, $staff->hubid, ['class' => 'form-control'])); ?>
              ...
              <?php endif; ?>
               ...
               <div class="form-group">
                ...
                <div class="form-group">
                  <label for="code" class="col-sm-2 control-label"><?php echo e(Form::label('code', 'Mobile App Login Code')); ?></label>

                  <div class="col-sm-10">
                    <?php echo e(Form::text('code', null, array('class' => 'form-control', 'id' => 'code'))); ?>
                ...
                <?php if($pagetype == 1): ?>
                    <div class="form-group">
                      ...
                      <div class="col-sm-3">
                        <?php echo e(Form::text('permitexpirydate', null, array('class' => 'form-control', 'id' => 'permitexpirydate', 'placeholder' => 'Expiry Date'))); ?>
              ...
              <div class="box-footer">
                ...
                <?php echo e(Form::submit('Update', array('class' => 'btn btn-sm btn-warning pull-right'))); ?>
