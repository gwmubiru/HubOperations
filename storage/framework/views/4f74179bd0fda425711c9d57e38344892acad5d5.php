...
<div class="container" style="padding-top:20px;">
	<div class="row">
    	<div class="col-md-4"><img src="<?php echo e(asset('img/aslmlogo.png')); ?>" class="img-responsive pull-left" width="170"></div>
        <div class="col-md-4" align="center"><img src="<?php echo e(asset('img/coat_of_arms.png')); ?>" class="img-responsive" width="170"></div>
        <div class="col-md-4"><img src="<?php echo e(asset('img/cdc.png')); ?>" class="img-responsive pull-right"></div>
    </div>
</div>
