      ...
      <ul class="nav nav-tabs">
        ...
        <a class="btn btn-sm btn-info text-muted" href="javascript:void(0)"
                  ...
                  <span class="fa fa-thumbs-o-up"></span>
                        Mark bike fixed</a>
        <?php else: ?>
        <a href="<?php echo e(route('equipment.breakdown',['hubid' => $equipment->hub->id, 'id' => $equipment->id])); ?>" class="text-muted btn btn-primary"><i class="fa fa-gear"></i> Report Break Down</a>
        <?php endif; ?>
        </li>
      </ul>
