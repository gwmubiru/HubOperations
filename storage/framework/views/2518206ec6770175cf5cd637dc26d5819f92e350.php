    ...
    <table id="listtable" class="table table-striped table-bordered">
      <thead>
        <tr>
          ...
          <th>Status</th>
          <th>Received at</th>
          <?php if (\Entrust::hasRole(['hub_coordinator','cphl_sample_reception'])) : ?>
          <th>Action</th>
          <?php endif; // Entrust::hasRole ?>
        </tr>
      </thead>
      ...
      <td><?php echo e($sample->numberofenvelopes); ?></td>
       ...
       Waiting Pickup 
        ...
        <?php if($sample->status < 3): ?>
        <a href="<?php echo e(route('sampletracking.receivesample',$sample->id)); ?>">Receive</a>
        <?php endif; ?>
        <?php endif; // Entrust::hasRole ?>
        </td>
        <?php endif; // Entrust::hasRole ?>
