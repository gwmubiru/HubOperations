...
<?php $__env->startSection('title', 'Update Hub'); ?>
...
<?php $__env->startSection('content'); ?>
	...
	<?php endif; ?>
            ...
            <?php echo e(Form::model($hub, array('route' => array('hub.update', $hub->id),  'class' => 'form-horizontal', 'id' => 'hubform', 'method' => 'PUT'))); ?>
            ...
            <?php echo e(csrf_field()); ?>
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                 ...
                 <div class="form-group hidden">
                  <label for="email" class="col-sm-2 control-label"><?php echo e(Form::label('email', 'Email Address')); ?></label>
              ...
              <div class="box-footer">
                ...
                <?php echo e(Form::submit('Update Hub', array('class' => 'btn btn-warning pull-right'))); ?>
